...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public softCapEthAmount = 100 ether;
    uint256 public hardCapEthAmount = 1500 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = 0 ether;
    uint256 public maximumDepositEthAmount = 100 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x450705a9393813a6e1698076131D627c5cf7f22D;

        presaleStartTimestamp = now;
        presaleEndTimestamp = 1621022400;
    }
    struct Sale {
        address investor;
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0015015015015015 ether; // 666 tokens per BNB
        
        uint256 tokenAmount = msg.value.mul(1e18).div(rewardTokenCount);
        sales.push(Sale(msg.sender, tokenAmount));
    ...
    function releaseFunds() external onlyOwner {
        ...
        for(uint i = 0; i < sales.length; i++) {
            ...
            token.mint(sale.investor, sale.amountOfToken);
        }
    }
    ...
    function salesLength() public view returns (uint256) {
        return sales.length;
    }
